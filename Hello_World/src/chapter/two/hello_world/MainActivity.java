...
//MainActivity contains the Java Code for Starting the app's MainActivity window
...
public class MainActivity extends Activity {
	...
	protected void setStartUpWorldValues(){
		...
		earth.setPlanetColonies(1);							//Set Planet Colony to one	
		earth.setPlanetMilitary(1);                        //Set Planet Military to one
		earth.setColonyImmigration(1000);                 // Set Planet Population to 1,000
		earth.setBaseProtection(200);                    // Set Armed Forces to 100 
